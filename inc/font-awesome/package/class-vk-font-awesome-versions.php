	...
	class Vk_Font_Awesome_Versions {
		...
		static function versions() {
			...
			$versions = array(
				...
				'4.7'            => array(
					'label'   => '4.7 ( ' . __( 'Not recommended', 'vk-post-author-display' ) . ' )',
					'version' => '4.7',
					'type'    => 'web-fonts-with-css',
		...
		public static function ex_and_link() {
			...
			if ( $current_option == '5_WebFonts_CSS' || $current_option == '5_SVG_JS' ) {
				$ex_and_link = '<strong>Font Awesome 5</strong><br>' . __( 'Ex ) ', 'vk-post-author-display' ) . 'far fa-file-alt [ <a href="//fontawesome.com/icons?d=gallery&m=free" target="_blank">Icon list</a> ]';
			} else {
				$ex_and_link = '<strong>Font Awesome 4.7</strong><br>' . __( 'Ex ) ', 'vk-post-author-display' ) . 'fa-file-text-o [ <a href="//fontawesome.com/v4.7.0/icons/" target="_blank">Icon list</a> ]';
			}
			return $ex_and_link;
		}
		...
		static function customize_register( $wp_customize ) {
			...
			$wp_customize->add_control(
				'vk_font_awesome_version',
				array(
					'label'       => __( 'Font Awesome Version', 'vk-post-author-display' ),
					'section'     => 'VK Font Awesome',
					'settings'    => 'vk_font_awesome_version',
					'description' => __( '4.7 will be abolished in the near future.', 'vk-post-author-display' ),
					'type'        => 'select',
					'priority'    => '',
					'choices'     => $choices,
				)
