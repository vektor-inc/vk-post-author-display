	...
	class Vk_term_color {
		...
		function taxonomy_add_new_meta_field_color() {
			...
			<?php wp_nonce_field( basename( __FILE__ ), 'term_color_nonce' ); ?>
				<label for="term_color"><?php _e( 'Color', 'vk-post-author-display' ); ?></label>
		...
		function taxonomy_add_edit_meta_field_color( $term ) {
			...
			?>
			<tr class="form-field">
			<th scope="row" valign="top"><label for="term_color"><?php _e( 'Color', 'vk-post-author-display' ); ?></label></th>
				<td>
				<?php wp_nonce_field( basename( __FILE__ ), 'term_color_nonce' ); ?>
		...
		function edit_term_columns( $columns ) {
			...
			$columns['color'] = __( 'Color', 'vk-post-author-display' );
